...
export default function Gallery({ images }: { images: Image[] }) {
  return (   
    <div className="mx-auto max-w-1xl py-8 px-4 sm:pb-24 sm:px-6 lg:max-w-[100%] lg:px-8 ">
      ...
      <div className="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 xl:gap-x-6">
        {images.map((image) => (
